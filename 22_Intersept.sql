...
-- Prod_name A nie zostanie wyswietlony bo wszystkie kolumny musza być identyczne 
SELECT * FROM sales1
INTERSECT
SELECT * FROM sales2;

-- Prod_name A wyświetlony bo bierzemy pod uwagę tylko dane z kol prod_name 
