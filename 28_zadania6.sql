/*
1. Z tabeli Product wyświetl kolumnę UnitsInStock. Dodatkowo dodaj drugą kolumnę
...
-- 2. Wykorzystując zapytanie z powyższego ćwiczenia pogrupuj dane w kolumnie Product 
-- na poziomie UnitsInStockLevel i policz liczbę wystąpień dla każdej grupy.

SELECT COUNT(*) AS NoOfS,
		CASE 
			WHEN UnitsInStock == 0 THEN 'none'
			WHEN UnitsInStock < 20 THEN'low'
			WHEN UnitsInStock BETWEEN 20 AND 50 THEN 'medium'
